...
드랍테이블3 = [a.기사의갑옷, a.그림자늑대, a.드래곤갑주, a.소울맨서로브, w.강철검, w.서번트독니, w.용뼈대검, w.아크스태프, w.플레어보우, w.디바인해머,
                ac.강철목걸이, ac.치유의반지, ac.백금팔찌]
드랍테이블4 = [a.아처스피릿, a.불굴기사갑주, a.마력의지배자의로브, a.성스러운갑옷, w.아다만티움검, w.그림자용의어금니, w.매직마스터스태프, w.태고의활, w.신이내린망치,
